...
class AttractionParameters(Enum):
    ...
    def get_folder_path(key):
        folder_path = {"dv": "\\media-testing\\LF-DV-(The-dragon)\\single_photo",
                       ...
                       "AV-XV-left": "\\media-testing\\AV-XV-(X2-left)\\single_photo",
                       "AV-XV-right": "\\media-testing\\AV-XV-(X2-right)\\single_photo",
                       ...
                       "TT-SV-left": "\\media-testing\\TT-SV-(Beams-left)",
    ...
    def media_meta_data(key):
        media_meta_data = {
            "dq_meta_data": f'{{"syncTimeArray":[0.663,0.87,1.066,1.258,1.452,1.637],"cameraAngle":30,"roiArray":[{{"height":200,"name":"People","width":200,"x":10,"y":10}}],"originUUID":"{AttractionParameters.ORIGIN_UUID.value}","parentUUID":"5296fc80-b23d-11ee-9b5c-950a055deb6c"}}',
